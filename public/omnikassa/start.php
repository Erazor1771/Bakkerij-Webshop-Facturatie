...
//	$oOmniKassa->setReportUrl($aSettings['website_url'] . '/public/omnikassa/report.php'); // Mag geen additionele parameters bevatten
//	$oOmniKassa->setReturnUrl($aSettings['website_url'] . '/public/omnikassa/return.php'); // Mag geen additionele parameters bevatten

	$oOmniKassa->setReportUrl($aSettings['website_url'] . '/omnikassa/report.php'); // Mag geen additionele parameters bevatten
	$oOmniKassa->setReturnUrl($aSettings['website_url'] . '/omnikassa/return.php'); // Mag geen additionele parameters bevatten
